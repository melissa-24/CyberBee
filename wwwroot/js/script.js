...
function update_user_title(title) {
    ...
    document.getElementById("inputTitle").innerText = terminal_user_title + " > ";
}
...
document.getElementById('inputSource').onblur = function() {
    document.getElementById("inputSource").focus();
};

document.getElementById('inputSource').addEventListener('keyup', submit_command);
...
function submit_command() {
    ...
    var command = document.getElementById("inputSource").value;
